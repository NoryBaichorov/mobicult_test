...
ActiveRecord::Schema[7.1].define(version: 2024_10_08_141903) do
  ...
  create_table "statistics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["footballer_id"], name: "index_statistics_on_footballer_id"
    t.index ["match_id"], name: "index_statistics_on_match_id"
  end

  add_foreign_key "statistics", "footballers"
